...
Skill = json.dumps({"offersProductionService": "DrillingService", "processToM": "Metal",
                    "Geometrie": "Kreis",
...
Preise = json.dumps({"minPrice": 200.0, "maxPrice": 1000.0, "priceFunction": "linear"})
Preise = json.loads(Preise)

Zeiten = json.dumps({"minTime": 1.0, "maxTime": 2.0, "timeFunction": "linear"})
