...
_username = "LaserCuttingMachine17"
_passwd = ""
_host = "127.0.0.1"
_port = 1883
_timeout = 60
...
Maschinenname = "LaserCuttingMachine17"
MaschinenTyp = "ADT"
...
Skill = json.dumps({"offersProductionService": "DrillingService", "TypeOfMaterial": "Wood",
                    "Geometrie": "Kreis",
...
Zeiten = json.dumps({"timeFunction": "linear", "SteigungPreis": 2.0, "AbschnittPreis": 100.0})
