...
class Asset_Digital_Twin(Digital_Twin):
    ...
    def ADT_Ablauf(self):
        ...
        Art = Ich_bin["Fähigkeit"]["Art"]
        Material = Ich_bin["Fähigkeit"]["Material"]
        if self.Ontologie_Client.Existiert(self.Name, Art, Material)["boolean"] == False:
            Insert = """INSERT DATA {
                DMP:""" + self.Name + """ rdf:type owl:NamedIndividual ,
                DMP:Resource .
                DMP:""" + self.Name + """ DMP:diameterHoleResource "0.015"^^xsd:decimal .
                DMP:""" + self.Name + """ DMP:maxThickness "0.06"^^xsd:decimal .
                DMP:""" + self.Name + """ DMP:minThickness "0.02"^^xsd:decimal .
                DMP:""" + self.Name + """ DMP:offersProductionService DMP:DrillingService .
                DMP:""" + self.Name + """ DMP:processToM DMP:""" + Ich_bin["Fähigkeit"]["Material"] + """ .
            }"""
